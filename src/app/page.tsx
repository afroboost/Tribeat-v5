        ...
        <div className="max-w-3xl mx-auto text-center space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16 text-left">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Synchronisation parfaite</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Interaction en direct</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">Accessible partout</h3>
              <p className="text-sm text-gray-600">
